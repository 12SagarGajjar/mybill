<?php 
  ...
  class PDF extends FPDF
  {
    function Header(){
      ...
      // $this->SetTextColor(20,123,190);
      $this->SetTextColor(162, 40, 10 );
      // $this->SetDrawColor(10,10,10);
      $this->Cell(50,10,"Maruti Motors",0,1);
      $this->SetTextColor(0, 0, 0 );

      $this->SetFont('Arial','',14);
      $this->Cell(50,7,"Odhav ring road,",0,1);
      $this->Cell(50,7,"Ahmedabad 382355.",0,1);
    ...
    function Footer(){
      ...
      $this->SetY(-50);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,10,"for Maruti Motors",0,1,"R");
      $this->Ln(15);
      $this->SetFont('Arial','',12);
